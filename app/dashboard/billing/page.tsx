...
export default function Billing() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setSubs([{ subscription_product_id: "freelancer_monthly" }]);
      setHistory([
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="rounded-lg border border-neutral-200/70 bg-white/80 p-4">
            ...
            <div className="mt-2 flex gap-2">
              ...
              <a href="/pricing" className="px-3 py-2 text-sm rounded-md text-white" style={{ background: 'linear-gradient(135deg,#F97316,#1E3A8A)' }}>Manage Billing</a>
            </div>
          </div>
