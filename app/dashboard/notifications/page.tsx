...
export default function Notifications() {
  ...
  useEffect(() => {
    setItems([
      { id: "n1", text: "Verification RPT-1023 completed.", read: false },
      { id: "n2", text: "Invoice INV-2001 paid.", read: true },
      { id: "n3", text: "New comment on vendor Apex Supplies.", read: false }
    ]);
  }, []);
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
          <div className="rounded-lg border border-neutral-200/70 bg-white/80 p-4">
            ...
            <div className="mt-2 space-y-2 text-sm">
              ...
              <button onClick={savePrefs} className="mt-2 w-full px-3 py-2 text-sm rounded-md border border-neutral-200/70">{t("notifications.save")}</button>
            </div>
          </div>
          <div className="md:col-span-2">
            <div className="mb-2"><button onClick={markAll} className="px-3 py-2 text-sm rounded-md border border-neutral-200/70">Mark all as read</button></div>
