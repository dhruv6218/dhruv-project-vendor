    ...
    <div className="mx-auto max-w-7xl px-4 md:px-6 py-10">
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-base text-[#475569] mt-2">Empowering businesses to validate vendors, mitigate fraud, and ensure compliance with AI-driven insights and verified data.</p>
        </div>
      </div>
      ...
      <section className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <ElectricBorder color={ORANGE} speed={1} chaos={0.5} thickness={2} style={{ borderRadius: 16 }}>
          <div className="p-5 rounded-2xl bg-white/60 backdrop-blur">
            ...
            <p className="text-base text-[#475569] mt-2">
              Ravono started in March 2025 with a vision to eliminate vendor fraud and simplify compliance for businesses of all sizes. Our founder, Dhruv, recognized
              the pain points in vendor verification while working on client projects and decided to build a platform that combines automation, AI, and government-backed
              verification APIs. Since inception, we focus on enterprise-grade tools that are easy to use, scalable, and reliable, giving businesses confidence to onboard vendors without risk.
            </p>
          </div>
        </ElectricBorder>
        {/* Mission */}
        <ElectricBorder color={ORANGE} speed={1} chaos={0.5} thickness={2} style={{ borderRadius: 16 }}>
          <div className="p-5 rounded-2xl bg-white/60 backdrop-blur">
            ...
            <p className="text-base text-[#475569] mt-2">
              To empower businesses globally with secure, accurate, and automated vendor verification, ensuring that every partnership is built on trust and compliance.
              We aim to reduce fraud, streamline onboarding, and make compliance effortless for our clients.
            </p>
          </div>
        </ElectricBorder>
        {/* Vision */}
        <ElectricBorder color={ORANGE} speed={1} chaos={0.5} thickness={2} style={{ borderRadius: 16 }}>
          <div className="p-5 rounded-2xl bg-white/60 backdrop-blur">
            ...
            <p className="text-base text-[#475569] mt-2">
              To become the world’s most trusted vendor compliance platform, setting industry standards for accuracy, security, and usability. We envision a future
              where businesses of all sizes can instantly verify vendors and make informed decisions with confidence.
            </p>
          </div>
        </ElectricBorder>
        {/* Values */}
