...
export const TRUSTED_LOGOS: TrustedLogo[] = [
  ...
  { name: "Sky Logistics", alt: "Trusted by Sky Logistics" },
  { name: "Vertex Tech", alt: "Trusted by Vertex Tech" },
  { name: "Metro Foods", alt: "Trusted by Metro Foods" },
  { name: "Astra Infra", alt: "Trusted by Astra Infra" }
];

export const STATS: StatItem[] = [
  { icon: "mdi:shield-check", label: "Verifications Done", value: 50000, suffix: "+" },
  { icon: "mdi:cloud-check", label: "Uptime", value: 99.99, suffix: "%" },
  { icon: "ri:team-line", label: "Businesses Served", value: 1500, suffix: "+" },
  { icon: "mdi:star", label: "Avg. Customer Rating", value: 4.7, suffix: "/5" }
];

export const VALUE_PROPS: ValueProp[] = [
  { icon: "heroicons:check-badge-20-solid", title: "Instant GST/PAN/Aadhaar Check", description: "Verify key documents in seconds—no manual back-and-forth." },
  { icon: "mdi:security", title: "Automated Fraud Detection", description: "AI flags anomalies and risky signals before they become losses." },
  { icon: "material-symbols:picture-as-pdf", title: "Branded PDF Reports in Minutes", description: "Export clean, stakeholder-ready PDFs branded with your company." }
];
